...
static NSTimeInterval POPUP_VIEW_INTERVAL = 0.26;
...
-(void)show {
    ...
    [UIView animateWithDuration:POPUP_VIEW_INTERVAL
                     ...
                     completion:^(BOOL finished) {
                         ...
                         [UIView animateWithDuration:POPUP_VIEW_INTERVAL animations:^{
    ...
    [UIView animateWithDuration:2 * POPUP_VIEW_INTERVAL delay:0
                        options:UIViewAnimationOptionCurveEaseInOut
                     animations:^{
                         _modalView.center = CGPointMake(self.frame.size.width / 2.0, self.frame.size.height - _modalView.frame.size.height / 2.0);
                     }
...
-(void)hide {
    ...
    [UIView animateWithDuration:2.2 * POPUP_VIEW_INTERVAL
                          delay:0.3 * POPUP_VIEW_INTERVAL
                        options:UIViewAnimationOptionCurveEaseInOut
                     animations:^{
                         _modalView.center = CGPointMake(self.frame.size.width/2.0, self.frame.size.height + _modalView.frame.size.height / 2.0);
                     }
